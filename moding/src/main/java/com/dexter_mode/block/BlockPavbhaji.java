...
public class BlockPavbhaji extends BlockCake{
	 ...
	 public BlockPavbhaji(Properties properties) {
		super(properties);
	...
	public VoxelShape getShape(IBlockState state, IBlockReader worldIn, BlockPos pos) {
	   ...
	   private boolean eatCake(IWorld worldIn, BlockPos pos, IBlockState state, EntityPlayer player) {
	      if (!player.canEat(false)) {
	    	 ...
	    	 player.addPotionEffect(new PotionEffect(Potion.getPotionById(1),60000));
